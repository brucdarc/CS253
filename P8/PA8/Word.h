...
inline bool isSentEnd() {return ST.isSentEnd(word);}; // returns true if isPEQ and is punctonly

inline bool isAlphaNumeric() {return ST.isAlphaNumeric(word);};	//same as stringtest
